...
<div class="innerOFA">
	...
	<!--//appl-tab-->
	<form name="tx_editor_form" style="width: 920px;" id="tx_editor_form" action="/cas/member/${resultUrl}" method="post" accept-charset="utf-8">
	...
	<td>
	<input type="text" class="faceb in_comn" value="" name="prj_facebook"><span class="d_cmn">※  입력 시 'http://' 제외</span>
	</td>
	</tr>
	<tr class="nth15">
	<th scope="row">블로그</th>
