...
<!-- 	</tr> -->
	<tr>
		...
		<td>
			...
			<textarea style="width:100%;height:50px" name="note">${report[0].reportContent}</textarea>
			
		</td>
	</tr>
	<tr>
		<td colspan="2" align="center"><input type="submit" onclick = "reportDelete_go();"value="신고글 삭제하기">
		</td>
	</tr>

<script>
function reportDelete_go(){
	location.href="reportDelete?contentNum=${report[0].contentNum}";
}
</script>
