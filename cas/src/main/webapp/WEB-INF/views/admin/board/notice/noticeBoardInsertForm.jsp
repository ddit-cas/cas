	...
	<div class="company-wrap">
		...
		<c:choose>
			<c:when test="${not empty articleVO}">
				<h3 class="box">공지사항 수정</h3>
			</c:when>
			<c:otherwise>
				<h3 class="box">공지사항 등록</h3>
			</c:otherwise>
		</c:choose>
				...
				<div id="home" class="tab-pane fade in active">
					<div class="content col-md-6" style="font-size: 16px">
						<form name="tx_editor_form" style="width: 800px;"
							id="tx_editor_form" action="/cas/admin/${resultUrl}"
								...
								<table class="table table-bordered"
									...
									<tbody>
										<tr>
											...
											<td><input name="contentTitle" value="${articleVO.contentTitle }" type="text" id="title"
							...
							<div id="tx_trex_container" class="tx-editor-container"
								...
								<div id="tx_sidebar" class="tx-sidebar">
									<div class="tx-sidebar-boundary" style="width: 745px;">
										<!-- 사이드바 / 첨부 -->
