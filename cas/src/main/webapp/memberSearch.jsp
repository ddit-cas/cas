				...
				<div class="paging_comm">
					...
					<a href="javascript:void(0);" class="ico_comm btn_fst">처음 페이지</a> 
						<a href="javascript:void(0);" class="ico_comm btn_prev">이전 페이지</a>
							...
							<a href="javascript:void(0);" style="padding-top:20px;" class="link_page on">1</a> 
							<a href="javascript:PageTbl('2|4');" class="link_page">2</a> 
							<a href="javascript:PageTbl('3|4');" class="link_page">3</a> 
							<a href="javascript:PageTbl('4|4');" class="link_page">4</a> 
							<a href="javascript:PageTbl('5|4');" class="link_page">5</a> 
							<a href="javascript:PageTbl('6|4');" class="link_page">6</a> 
							<a href="javascript:PageTbl('7|4');" class="link_page">7</a> 
							<a href="javascript:PageTbl('8|4');" class="link_page">8</a> 
							<a href="javascript:PageTbl('9|4');" class="link_page">9</a> 
							<a href="javascript:PageTbl('10|4');" class="link_page">10</a> 
						
						<a href="javascript:PageTbl('11|4');" class="ico_comm btn_next">다음 페이지</a> 
					<a href="javascript:PageTbl('25|4');" class="ico_comm btn_lst">끝페이지</a>
